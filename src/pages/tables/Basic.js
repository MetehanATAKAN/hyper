...
import { ModalSizes } from '../uikit/Modals';
...
const ResponsiveTable = ({tabContents}) => {
    return (
        <Card>
            <Card.Body>
               ...
               {/* <ModalSizes sizem={'lg'} title={'Add Activity Limit and Settings'} tab={<BorderedTabs tabContents={tabContents} />} />  */}
                </div>
...
const Tables = ({tabContents}): React$Element<React$FragmentType> => {
    return (
        <React.Fragment>
            <PageTitle
                breadCrumbItems={[
            ...
            <Row>
                <Col>
                    <ResponsiveTable tabContents={tabContents} />
                </Col>
            </Row>
        </React.Fragment>
    );
