...
const MaterialServiceTable = (props) => {
    ...
    const columns = [
        ...
        {
            header: t('Category Sub 2'),
            accessorKey: 'categorySub2',
            size: '170'
        },
        {
            header: t('Category Sub 3'),
            accessorKey: 'categorySub3',
            size: '170'
        },
        {
...
export default React.memo(MaterialServiceTable);
