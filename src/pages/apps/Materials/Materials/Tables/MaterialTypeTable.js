...
const MaterialTypeTable = (props) => {
    ...
    const columns = [
        {
            header: t('Material or Services'),
            accessorKey: 'materialService',
            size: '170'
        },
        {
            header: t('Material or Services Type'),
...
export default React.memo(MaterialTypeTable);
