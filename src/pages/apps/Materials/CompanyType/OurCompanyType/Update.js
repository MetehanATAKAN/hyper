...
const Update = ({ handleUpdate, selectedValue, isShow, setIsShow }) => {
    const [companyType, setCompanyType] = useState(selectedValue.name);
  ...
  return (
    <Modal show={isShow} onHide={toggle} size={'md'} >
                ...
                <Modal.Body>
                    ...
                    <Row>
                        <Form.Control type="text" placeholder={t('company')} value={companyType} onChange={(e) => setCompanyType(e.target.value)} />
                    </Row>
                    <Row className='mt-3'>
                ...
                <Modal.Footer style={{ backgroundColor: '#FAFBFE ' }} >
                    ...
                    <Button
                        ...
                        onClick={() => handleUpdate(companyType, description)}
                        disabled={
