...
const OurCompanyType = ({ modalTabValue, setModalTabValue, handleAddModal, handleAddModalStatus, setHandleAddModalStatus }) => {
    ...
    useEffect(() => {
        if(handleAddModalStatus.clickAdd === true && handleAddModalStatus.tabName === 'Our Company Type'){
    ...
    const handleClickDeleteButton = () => {
        FetchApiPost('services/Material/OurCompany/DeleteOurCompanyType', 'POST', {
            companyTypeId: deleteItem.id,
    ...
    const handleUpdate = (name, description) => {
        FetchApiPost('services/Material/OurCompany/UpdateOurCompanyType', 'POST', {
            id: updateItem.id,
            name: name,
