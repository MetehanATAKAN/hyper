...
const PageGalleryTemplates = ({templates,setTemplates}) => {
    ...
    const newTemlateModal = () => {
        ...
        FetchApiGet('services/Pages/Page/GetGlobalBrandList', 'GET')
            ...
            .then(response => setProductsOptions(
    ...
    const saveNewTemplate = () => {
        ...
        FetchApiPost('services/Pages/Page/SaveDesignPageLabel', 'POST', body)
            .then((res) =>
                (async () => {
                    try {
                        if (res.status === 201) {
    ...
    // useEffect(() => {
    //     // FetchApiGet(activeTemplateId === 1 
    ...
    //         FetchApiGet('services/Pages/Benefit/GetAllBenefitPageGalery','GET')
    //         .then((res) =>
    //             (async () => {
    //                 try {
    //                     if (res.status === 200) {
    ...
    //             })()
    //         )
    // }, [activeTemplateId, history, setTemplates])
                    ...
                    } */}
                    {
                        templates.map((img, index) => (
                            <>
                                ...
                                >
                                    <LeftCornerRibbon backgroundColor={img.cornerColor} color="rgb(255, 255, 228)" fontFamily="Arial" zIndex='9999' >
                                        {img.cornerText}
                                    </LeftCornerRibbon>
                                            ...
                                            <div className='items'>
                                                ...
                                                <Link
                                                    to={{
                                                        ...
                                                        search: `?id=${img?.detailsId}&name=benefit`,
                                                        hash: "#the-hash",
