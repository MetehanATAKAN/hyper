...
const NewButton = ({ showModal, setShowModal, setBrochuries, brochuries, applyFilter }) => {
        ...
        switch (selectName) {
            case 'product':
                if (selectIndication.length === 0 || selectProfile.length === 0 || selectNeed === 0) {
                    return setSelectProduct(e);
                } else {
                    return setSelectProduct(e), setSelectIndication([]), setSelectProfile([]), setSelectNeed([]);
                }
            case 'indication':
                if (selectProfile.length === 0 || selectNeed === 0) {
                    return setSelectIndication(e);
                } else {
                    return setSelectIndication(e), setSelectProfile([]), setSelectNeed([]);
                }
            case 'profile':
                if (selectNeed !== 0) {
                    return setSelectProfile(e);
                } else {
                    return setSelectProfile(e), setSelectNeed([]);
                }
            case 'need':
                return setSelectNeed(e);
