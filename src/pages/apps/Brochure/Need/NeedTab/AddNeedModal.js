...
const AddNeedModal = ({ isShow, setIsShow, needFilter }) => {
    ...
    const addNeed = () => {
        ...
        FetchApiPost('services/Pages/Need/SaveNeed', 'POST', addNeedBody).then((res) =>
            (async () => {
                try {
                    if (res.status === 201) {
                        setIsShow(false);
            ...
            <GlobalModal
                ...
                footer={
                    <>
                        ...
                        <Button className="btn-primary" onClick={addNeed}>
                            {t('add')}
                        </Button>
                    </>
                }
