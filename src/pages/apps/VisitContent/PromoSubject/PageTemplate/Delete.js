...
const Delete = ({ modalShow, setModalShow, item, getFilterData }) => {
    ...
    const deleteBenefit = () => {
        ...
        FetchApiPost('services/Pages/ProductPage/DeleteProductPage', 'POST', item).then((res) => {
                    ...
                    <Modal.Body>
                        <div className="alert-modal-items">
                            ...
                            <div className="alert-modal-question">
                                ...
                                <br /> "{
                                item.visitContent === 'profile' ? t('Profile') :
                                item.visitContent === 'need' ? t('Need') :
                                item.visitContent === 'benefit' ? t('Benefit') :
                                item.visitContent === "whatCanBeInterestingPage" ? t("What can be interesting for a doctor in the discussion of the topic") :
                                item.visitContent === "situationPage" ? t("Situation Clarification of the situation") :
                                item.visitContent === "problemIdentificationPage" ? t("Problem Identification of Availability of Disadvantages in Life") :
                                item.visitContent === "identificationEvaluationPage" ? t("Identification Evaluation of Unwanted Consequences") :
                                item.visitContent === "nonPromoPage" ? t("non promo") : ""
                                }"
                            </div>
