...
const CalendarDragDropTable1 = ({ handleDragEnd, droppableId, line, month1, length, month2, activeDraggable, clickRow, calendarDatas, janxx, lineNumber, frequency }) => {
...
export default CalendarDragDropTable1