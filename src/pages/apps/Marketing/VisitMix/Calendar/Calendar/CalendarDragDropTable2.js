...
const CalendarDragDropTable2 = ({ handleDragEnd, droppableId, line, month1, length, month2, month3, activeDraggable, clickRow, calendarDatas, janxx, lineNumber, frequency }) => {
                ...
                clickRow
                    ...
                    : month1[0] === undefined
                        ...
                        : month1[0].brandName === record.brandName && month1[1].brandName === record.brandName && month1[2].brandName === record.brandName && month1[3].brandName === record.brandName
                            ? lineNumber >= 4 ? 'box2' : 'box1'
                            : index === 0 && month3[0] !== undefined && month1[0] !== undefined && month2[0] !== undefined && (month3[0].brandName === record.brandName || month2[0].brandName === record.brandName || month1[1].brandName === record.brandName)
                                ? 'calendarError'
                                : index === 0 && month3[0] !== undefined && month1[0] !== undefined && month2[0] === undefined && (month3[0].brandName === record.brandName || month1[1].brandName === record.brandName)
                                    ? 'calendarError'
                                    : index === 1 && month3[0] !== undefined && month1[0] !== undefined && month2[0] !== undefined && (month1[0].brandName === record.brandName || month1[2].brandName === record.brandName || month3[1].brandName === record.brandName || month2[1].brandName === record.brandName)
                                        ? 'calendarError'
                                        : index === 1 && month3[0] !== undefined && month1[0] !== undefined && month2[0] === undefined && (month1[0].brandName === record.brandName || month1[2].brandName === record.brandName || month3[1].brandName === record.brandName)
                                            ? 'calendarError'
                                            : index === 2 && month3[0] !== undefined && month1[0] !== undefined && month2[0] !== undefined && (month1[1].brandName === record.brandName || month1[3].brandName === record.brandName || month3[2].brandName === record.brandName || month2[2].brandName === record.brandName)
                                                ? 'calendarError'
                                                : index === 2 && month3[0] !== undefined && month1[0] !== undefined && month2[0] === undefined && (month1[1].brandName === record.brandName || month1[3].brandName === record.brandName || month3[2].brandName === record.brandName)
                                                    ? 'calendarError'
                                                    : index === 3 && month3[0] !== undefined && month1[0] !== undefined && month2[0] !== undefined && (month1[2].brandName === record.brandName || month3[3].brandName === record.brandName || month2[3].brandName === record.brandName)
                                                        ? 'calendarError'
                                                        : index === 3 && month3[0] !== undefined && month1[0] !== undefined && month2[0] === undefined && (month1[2].brandName === record.brandName || month3[3].brandName === record.brandName)
                                                            ? 'calendarError'
                                                            : lineNumber >= 4 ? 'box2' : 'box1'
            )
        }
...
export default CalendarDragDropTable2