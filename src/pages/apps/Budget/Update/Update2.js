...
import { CustomSelect } from './Update1';
const Update2 = (props) => {
    const {
        radios,
        setRadios,
        ...
        <>
            <Row style={{ marginBottom: '16px' }}>
                <Col>
                    ...
                    <Form style={{ marginTop: '8px', color: '#6C757D', display: 'flex' }} onChange={radioClick}>
                        ...
                        />
                        <Tippy content="Add a new one if there is no service or material in the list" placement="top">
                    ...
                    {radios.radio1 === true ? (
                        ...
                        <>
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <span>{t('Service or Material')}</span>*
                            </div>
                            <Form.Control
                                type="text"
                                size="sm"
                                placeholder={t('Service or Material')}
                                value={serviceMaterialInput}
                                onChange={(e) => setServiceMaterialInput(e.target.value)}
                            />
                        </>
                    )}
                </Col>
            ...
            <Col style={{ marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Tippy
                        content="Must include all information to recognize and create a proper procurement request"
                        placement="top">
                        <span style={{ marginLeft: 'auto' }}>
                            <Icon size={1} path={mdiInformationOutline} />
                        </span>
            ...
            <Col style={{ marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Tippy
                        content="All costs must have an end goal and create added value for the company"
                        placement="top">
                        <span style={{ marginLeft: 'auto' }}>
                            <Icon size={1} path={mdiInformationOutline} />
                        </span>
...
export default React.memo(Update2);
