...
const UnitePrice = (props) => {
    ...
    const monthInputChange = (e, budgetIds, monthId, quantity) => {
    ...
    const tableData = budgetData?.map((el, i) => ({
        ...
        jan: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][0].budgetId, detailData[i][0].monthId, detailData[i][0].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][0].price}
                type="number"
                name="jan"
                size="small"
        ...
        feb: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][1].budgetId, detailData[i][1].monthId, detailData[i][1].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][1].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        mar: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][2].budgetId, detailData[i][2].monthId, detailData[i][2].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][2].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        apr: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][3].budgetId, detailData[i][3].monthId, detailData[i][3].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][3].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        may: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][4].budgetId, detailData[i][4].monthId, detailData[i][4].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][4].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        jun: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][5].budgetId, detailData[i][5].monthId, detailData[i][5].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][5].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        jul: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][6].budgetId, detailData[i][6].monthId, detailData[i][6].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][6].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        aug: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][7].budgetId, detailData[i][7].monthId, detailData[i][7].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][7].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        sep: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][8].budgetId, detailData[i][8].monthId, detailData[i][8].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][8].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
        ...
        oct: (
            <Input
                onChange={(e) =>
                    monthInputChange(e, detailData[i][9].budgetId, detailData[i][9].monthId, detailData[i][9].quantity)
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][9].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
            ...
            <Input
                onChange={(e) =>
                    monthInputChange(
                        ...
                        detailData[i][10].quantity
                    )
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][10].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
            ...
            <Input
                onChange={(e) =>
                    monthInputChange(
                        ...
                        detailData[i][11].quantity
                    )
                }
                placeholder="-"
                value={detailData.length !== 0 && detailData[i][11].price}
                type="number"
                name="jan"
                size="small"
                style={{ textAlign: 'right' }}
...
export default React.memo(UnitePrice);
